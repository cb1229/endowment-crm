      ...
      <div className="p-6 space-y-6">
        ...
        <div className="paper-container p-6">
          <div className="flex items-start gap-4 mb-4">
            ...
            <div className="flex-1">
              <h1 className="text-2xl font-semibold tracking-tight mb-2">{company.name}</h1>
        ...
        <div className="grid grid-cols-2 gap-4">
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-semibold tracking-tight">{company.stats.noteCount}</div>
            </CardContent>
          </Card>
          <Card>
            <CardHeader className="pb-2">
            ...
            <CardContent>
              <div className="text-2xl font-semibold tracking-tight">{company.stats.dealCount}</div>
            </CardContent>
          </Card>
        </div>
